...
public class HomePageController extends BaseController {
    ...
    public String handleRegister(@ModelAttribute("userDTO") @Valid RegisterDTO userDTO, BindingResult bindingResult,
        ...
        // Gọi hàm Service để tự động băm mật khẩu và tự gán ROLE_USER chuẩn chỉnh
        User user = this.userService.registerDTOtoUser(userDTO);

        // Lưu thông tin User hoàn hảo xuống Cơ sở dữ liệu
    ...
    public String postMethodName(Model model, @ModelAttribute("newUser") User trinhlam, BindingResult newBindingResult,
